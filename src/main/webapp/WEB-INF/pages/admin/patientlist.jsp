...
String showPatientPath = request.getContextPath()+"/admin/showpatient";
%>
<script>
		...
		<div class="content_box">
			<div class="content_box_nav">
				...
				<div class="content_box_nav_search">
					<input class="content_box_nav_search_input" type="text" name="searchPatient" id="searchPatient" placeholder="患者检索" maxlength="20">
					<input class="content_box_nav_search_submit" type="button" id="search" value="搜索"/>
				</div>
				
				<a href="/Huarui/admin/patientnon" class="patientnon">查找是否有不存在已有科室中的患者</a>
			</div>
			<hr/>
