...
<html>
<head>
	<title>华睿 - 无线体温数据监测系统 - 设备详情页面</title>
	...
	<link rel="stylesheet" href="/Huarui/asset/css/devicedetaillist.css"/>
...
<body>
	<div class="main">
		...
		<jsp:include page="/WEB-INF/pages/admin/devicedetaillist.jsp"/>
	</div>
</body>
</html>